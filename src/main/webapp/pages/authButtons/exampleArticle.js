define(['text!./exampleArticle.html',
    ...
    var listRowUrl, saveRowUrl, delRowUrl, updateStatusUrl, element;
    function init(element, cookie) {
        listRowUrl = "/exampleArticle/list"; //列表查询URL
        saveRowUrl = "/exampleArticle/save"; //新增和修改URL， 有id为修改 无id为新增
        delRowUrl = "/exampleArticle/delete"; //刪除URL
        updateStatusUrl = "/exampleArticle/updateStatus",
        element = element;
    ...
    viewModel.event = {
        ...
        updateStatus: function (data, status) {
            ...
            pjt.ajaxSaveData(updateStatusUrl,arr,function(result){
                viewModel.event.queryData();
            },function(result){
                pjt.message("请求异常");
            })
