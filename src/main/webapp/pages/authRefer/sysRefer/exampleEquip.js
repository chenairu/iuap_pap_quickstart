define(['text!./exampleEquip.html',
    ...
    function init(element, cookie) {
        ...
        listRowUrl = "/exampleEquip/list"; //列表查询URL
        saveRowUrl = "/exampleEquip/save"; //新增和修改URL， 有id为修改 无id为新增
        delRowUrl = "/exampleEquip/delete"; //刪除URL
    ...
    viewModel.formData.on("orgId.valueChange",function (e) {
        ...
        viewModel.event.orgNameChange(e);
    ...
    viewModel.event = {
        ...
        orgNameChange: function(e){
            var refValues = $("#refContainerorgId").data("uui.refer").values;
            if(refValues && refValues.length > 0){
                var orgId = refValues[0].refcode;
                viewModel.formData.setValue("orgName",refValues[0].refname);
            }
        }
