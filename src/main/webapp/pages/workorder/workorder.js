define(['text!./workorder.html',
    ...
    var init =  function (element, arg) {
		        	        	...
		        	        	if (result) {
		        	            	if (result.success == "success") {
		        	            		...
		        	            		if (data == null) {
			        	                	...
			        	                	//this.submitBPMByProcessDefineCode(selectedData, processDefineCode);
		        	            		}
		        	                } else {
		        	                	u.messageDialog({
                    		...
                    		if (res) {
                    			if (res.success == "success") {
                    				if (res.detailMsg.data) {
                    					...
                    					viewModel.formData.setSimpleData(res.detailMsg.data);
                    				} else {
                    					u.messageDialog({
        ...
        if(arg && arg.vtype && arg.vtype=='bpm'){
        	...
        	viewModel.id="3ed913c0-44cf-4333-b2ae-a4010b103efe";
            viewModel.flowEvent.openPage(viewModel.id);//加载表单数据
