package com.yonyou.iuap.example.supervise.entity;
...
@Entity(namespace = "iuap_qy",name = "ygdemo_yw_sub")
@Table(name = "ygdemo_yw_sub")
public class Ygdemo_yw_sub extends BaseEntity{
	 
    @FK(name = "fk_id_ygdemo_yw_sub", referenceTableName = "ygdemo_yw_info", referencedColumnName = "id") 
	...
	public void setZbr_name(String zbr_name) {
		this.zbr_name = zbr_name;
	}
